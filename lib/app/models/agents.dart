class ResponseValorantAPI {
  int status;
  List<ValorantAgent> data;
  ...
  factory ResponseValorantAPI.fromJson(Map<String, dynamic> json) =>
      ResponseValorantAPI(
        status: json["status"],
        data: List<ValorantAgent>.from(
            json["data"].map((x) => ValorantAgent.fromJson(x))),
      );
...
class ResponseValorantAgent {
  int status;
  ValorantAgent data;

  ResponseValorantAgent({
    required this.status,
    required this.data,
  });

  factory ResponseValorantAgent.fromJson(Map<String, dynamic> json) =>
      ResponseValorantAgent(
        status: json["status"],
        data: ValorantAgent.fromJson(json['data']),
      );
...
class ValorantAgent {
  ...
  factory ValorantAgent.fromJson(Map<String, dynamic> json) => ValorantAgent(
        uuid: json["uuid"],
...
class Ability {
  ...
  factory Ability.fromJson(Map<String, dynamic> json) => Ability(
        ...
        displayName: json["displayName"],
        description: json["description"],
        displayIcon: (json["displayIcon"] == null) ? '' : json["displayIcon"],
      );
